  ...
  const darkModeHandler = () => {
    ...
    <div className="container mx-auto px-4 py-6 flex justify-between items-center">
      ...
      <ul className="flex space-x-4">
        ...
        {currentUser && (
          <li>
            <Link to={"/rewards"} className="text-white hover:text-gray-300">
              Rewards
            </Link>
          </li>
        )}
