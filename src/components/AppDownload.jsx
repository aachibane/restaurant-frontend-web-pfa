    ...
    <section class="text-gray-400 bg-white bg-opacity-15 dark:bg-opacity-25 mb-6 backdrop-filter backdrop-blur-md dark:bg-[#005055] body-font">
      <div class="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
        <div class="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
          <h2 class="text-xs text-indigo-400 text-gray-500 tracking-widest font-medium title-font mb-1">
            ROOF PARTY POLAROID
          </h2>
          <h1 class="md:text-3xl text-2xl text-gray-500 font-medium title-font text-white">
