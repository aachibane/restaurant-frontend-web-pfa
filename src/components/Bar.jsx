...
export default function Bar() {
  ...
  return (
    <div className="bg-gray-50">
      ...
      <div
        id="Main"
        className={`${show ? '-translate-x-full' : 'translate-x-0'} bg-white transform  xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-72   flex-col h-full`}
      >
      ...
      ghjghj
      <div className="xl:flex-1 bg-gray-200">
        dfg <h1 className="text-2xl font-bold text-gray-800">Welcome to the Extra Space!</h1>
        <p className="text-gray-700">
          You can add any additional content here to utilize the extra space on the right.
        </p>
      </div>
    </div>
  );
