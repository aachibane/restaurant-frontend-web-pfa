...
const Footer = () => {
  ...
  return (
<footer class="text-gray-600 z-50 bg-white dark:bg-opacity-25 dark:bg-gray-400 bg-opacity-15 backdrop-filter backdrop-blur-md body-font">
  ...
  <div class="bg-gray-100 dark:bg-opacity-75 dark:bg-gray-800 backdrop-filter backdrop-blur-md">
