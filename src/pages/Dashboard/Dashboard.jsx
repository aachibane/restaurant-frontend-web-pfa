          ...
          <div class="flex flex-col justify-between flex-1 mt-6">
            <nav class="flex-1 -mx-3 space-y-3 ">
              ...
              >
                ...
                <span class="mx-2 text-sm font-medium">Clients</span>
              </a>
              <a
                class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                href="#"
              >
                ...
                <span class="mx-2 text-sm font-medium">Points</span>
              </a>
              ...
              >
                ...
                <span class="mx-2 text-sm font-medium">Points Setting</span>
              </a>
              ...
              >
                ...
                <span class="mx-2 text-sm font-medium">Feedbacks</span>
              </a>
            </nav>
          </div>
        </aside>
        <div className="flex-1 p-4 shadow-lg bg-secondary">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <DashboardCard
              title="Dashboard Card 1"
              content="Content for Dashboard Card 1"
            />
            <DashboardCard
              title="Dashboard Card 2"
              content="Content for Dashboard Card 2"
            />
            <DashboardCard
              title="Dashboard Card 3"
              content="Content for Dashboard Card 3"
            />
            <DashboardCard
              title="Dashboard Card 4"
              content="Content for Dashboard Card 4"
            />
            <DashboardCard
              title="Dashboard Card 5"
              content="Content for Dashboard Card 5"
            />
            <GraphComponent />
            <DashboardCard
              title="Dashboard Card 6"
              content="Content for Dashboard Card 6"
            />
          </div>
        </div>
      </div>
