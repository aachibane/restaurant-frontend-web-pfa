  ...
  return (
    <div className="h-full border-2 m-5 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
      <img
        ...
        src={'http://localhost:8080/api/restaurants/files/' + restaurant.imageurl}
        alt="blog"
      />
      <div className="p-6 bg-white">
        ...
        <p className="leading-relaxed mb-3">{restaurant.description}</p>
        <div className="flex items-center flex-wrap ">
          ...
          <span className="text-gray-400 inline-flex items-center leading-none text-sm">
            ...
            {restaurant.openingHours} - {restaurant.status}
          </span>
        </div>
      </div>
    </div>
