                ...
                <div className="w-full lg:w-4/12 px-4 lg:order-1">
                  <div className="flex justify-center py-4 lg:pt-4 pt-8">
                    <div className="mr-4 p-3 text-center">
                      ...
                      <span className="animate-pulse text-sm text-blueGray-400">Rating</span>
                    </div>
                    <div className="mr-4 p-3 text-center">
                      <span className="text-xl font-bold block uppercase tracking-wide text-blueGray-600">
                        <p className="animate-pulse w-24 h-2 mt-6 bg-gray-200 rounded-lg dark:bg-gray-600"></p>
                      </span>
                      <span className="animate-pulse text-sm text-blueGray-400">Likes</span>
                    </div>
                    <div className="mr-4 p-3 text-center">
                      <span className="text-sm text-blueGray-400">
                        <p className="animate-pulse w-24 h-2 mt-6 bg-gray-200 rounded-lg dark:bg-gray-600"></p>
                      </span>
                      <span className="animate-pulse text-sm text-blueGray-400">Price Range</span>
                    </div>
                  </div>
                </div>
              </div>
